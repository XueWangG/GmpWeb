...
<div class="container">
      	...
      	<div class="container-body">
			...
			<form class="form-inline" onsubmit="return check()" action="<?php echo base_url()?>index.php/question/create" method="POST">
				...
				<div class="control-group">
			    	<div class="controls">
			    		...
			    		试题分类&nbsp;&nbsp;&nbsp;
						<select id="s_cat1" onchange="cat1_callback()" name="ques_cat" class="span2">
							<?php 
			    		...
			    		难度
			    		<select id="s_cat2" onchange="cat2_callback()" name="ques_difficulty" class="span2">
							<?php 
						...
						SOP
						<select id="s_cat3" onchange="refresh_cat_preview()" name="ques_sop" class="span2">
							<?php 
			   ...
			   <div class="control-group">
			    	...
			    	<div class="controls">
			    		<textarea id="question_content" name="question_content" rows="10" class="span5"></textarea>
			    	</div>
			    </div>
			    <!-- A -->
			    <div id="div_choice_a" class="control-group span4">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_a" name="choice_content_a" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
			    <!-- B -->
			    <div id="div_choice_b" class="control-group span4">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_b" name="choice_content_b" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
			    <!-- C -->
			    <div id="div_choice_c" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_c" name="choice_content_c" rows="5" class="span3"></textarea>
			    	</div>
			    </div>	
			    <!-- D -->
			    <div id="div_choice_d" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_d" name="choice_content_d" rows="5" class="span3"></textarea>
			    	</div>
			    </div>			    
			    <!-- E -->
				<div id="div_choice_e" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_e" name="choice_content_e" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
				<!-- F -->
				<div id="div_choice_f" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_f" name="choice_content_f" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
				<!-- G -->
				<div id="div_choice_g" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_g" name="choice_content_g" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
				<!-- H -->
				<div id="div_choice_h" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_h" name="choice_content_h" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
				<!-- I -->
				<div id="div_choice_i" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_i" name="choice_content_i" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
				<!-- J -->
				<div id="div_choice_j" class="control-group span4" style="display:none;">
			    	...
			    	<div class="controls">
			    		<textarea id="choice_content_j" name="choice_content_j" rows="5" class="span3"></textarea>
			    	</div>
			    </div>
