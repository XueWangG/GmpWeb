...
<?php echo "var baseurl='".base_url()."';" ;?>
	...
	function commit(){
	 ...
	 $(function () {
        ...
        $("#test_paper_id").val(<?php echo $test_info['test_paper_id']; ?>);
...
<div class="container-body">
	...
	<?php }?>
	<!-- 错误信息提示 结束 -->
	<form class="form-horizontal" id="create_form" action="<?php echo base_url()?>index.php/test/update/<?php echo $test_info['test_id']; ?>" method="POST">
	<div class="control-group">
	<label class="control-label">测试名称：</label>
	<div class="controls">
		<input type="text" id="test_name" name="test_name" maxlength="50" value="<?php echo $test_info['test_name']; ?>">
	</div>
	</div>
	<div class="control-group">
	...
	<div class="controls">
          <input class="span2" type="text" id="datepicker" name="start_time"  value="<?php echo $test_info['start_time']; ?>" placeholder="开始日期" onfocus="this.blur()">
          ~
          <input class="span2" type="text" id="datepicker_end" name="end_time" value="<?php echo $test_info['end_time']; ?>" placeholder="结束日期" onfocus="this.blur()">
